...
export const dashboardActions: DashboardActionItem[] = [
  {
    ...
    accountId: 'ACC-201',
    accountName: 'Acme Corporation',
    opportunityName: 'Acme Enterprise Platform',
    repId: 'REP-001',
    ownerName: 'Sarah Chen',
    region: 'West',
    segment: 'Enterprise',
    actionType: 'EXEC_SPONSOR_OUTREACH',
    actionTitle: 'Schedule executive sponsor call',
    actionDescription: 'Champion has gone dark for 12 days. Recommend CRO outreach to VP Engineering contact.',
    priority: 95,
    expectedImpact: 'High',
    expectedImpactAmount: 180000,
    confidence: 0.82,
    reasoning: 'Historical data shows 3.2x higher close rate when exec sponsor engaged at this stage.',
    dueDate: '2024-11-18',
    createdAt: '2024-11-15T08:00:00Z',
    status: 'Open',
    source: 'AI Generated',
    playbook: 'Hero Deal Recovery',
    amount: 450000,
    healthScore: 38,
  ...
  },
  {
    ...
    opportunityName: 'TechStart Growth Package',
    repId: 'REP-002',
    ownerName: 'David Kim',
    region: 'East',
    segment: 'Mid-Market',
    actionType: 'MULTI_THREAD_DEAL',
    actionTitle: 'Expand stakeholder coverage',
    actionDescription: 'Single-threaded to technical buyer. Need to engage economic buyer before negotiation.',
    priority: 88,
    expectedImpact: 'Medium',
    expectedImpactAmount: 45000,
    confidence: 0.75,
    reasoning: 'Deals with 3+ stakeholders have 2.1x higher win rate in Mid-Market segment.',
    dueDate: '2024-11-20',
    createdAt: '2024-11-15T09:30:00Z',
    status: 'Open',
    source: 'AI Generated',
    playbook: 'Multi-Thread Expansion',
    amount: 180000,
    healthScore: 52,
    healthCategory: 'Monitor',
    riskLevel: 'Medium',
    needsAttention: true,
  },
  {
    ...
    accountId: 'ACC-203',
    accountName: 'GlobalTech Solutions',
    opportunityName: 'GlobalTech Platform Renewal',
    repId: 'REP-003',
    ownerName: 'Emily Rodriguez',
    region: 'West',
    segment: 'Enterprise',
    actionType: 'NEGOTIATE_TERMS',
    actionTitle: 'Address pricing objection',
    actionDescription: 'Stuck in negotiation for 18 days. Competitor offering 15% lower price. Consider value-add bundle.',
    priority: 78,
    expectedImpact: 'High',
    expectedImpactAmount: 95000,
    confidence: 0.68,
    reasoning: 'Similar competitive situations resolved with value-add in 72% of cases.',
    dueDate: '2024-11-22',
...
export const impactTracker: InboxImpactMetrics[] = [
  {
    quarter: 'Q4 2024',
    region: 'West',
    segment: 'Enterprise',
    actionsCreated: 45,
    actionsWithDecision: 38,
    actionsWithoutDecision: 7,
    avgTimeToDecisionDays: 2.1,
    totalExpectedImpactAmount: 2850000,
    totalRealizedImpactAmount: 2620000,
    dealsWon: 12,
    dealsLost: 4,
    dealsSlipped: 3,
    decisionRate: 0.84,
    realizedVsExpectedRatio: 0.92,
    lastUpdatedTs: '2024-11-15T10:00:00Z',
  },
  {
    quarter: 'Q4 2024',
    region: 'East',
    segment: 'Mid-Market',
    actionsCreated: 62,
    actionsWithDecision: 41,
    actionsWithoutDecision: 21,
    avgTimeToDecisionDays: 3.4,
    totalExpectedImpactAmount: 1950000,
    totalRealizedImpactAmount: 1420000,
    dealsWon: 15,
    dealsLost: 8,
    dealsSlipped: 6,
    decisionRate: 0.66,
    realizedVsExpectedRatio: 0.73,
    lastUpdatedTs: '2024-11-15T10:00:00Z',
  },
  {
    quarter: 'Q4 2024',
    ...
    segment: 'Enterprise',
    actionsCreated: 38,
    actionsWithDecision: 29,
    actionsWithoutDecision: 9,
    avgTimeToDecisionDays: 2.8,
    totalExpectedImpactAmount: 2100000,
    totalRealizedImpactAmount: 1890000,
    dealsWon: 9,
    dealsLost: 5,
    dealsSlipped: 2,
    decisionRate: 0.76,
    realizedVsExpectedRatio: 0.90,
    lastUpdatedTs: '2024-11-15T10:00:00Z',
  },
]
